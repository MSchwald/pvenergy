...
Moreover, provide `--tune` for using Optuna to optimize hyperparameters and the optional arguments `--trials <number=10>`, `--cv <number=3>` to specify the number of trials or cross-validations.
