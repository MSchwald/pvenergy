...
* **`tune`**: Uses Optuna to optimize hyperparameters. Provide the arguments `--trials <number=10>`, `--cv <number=3>` to specify the number of trials or cross-validations. Use the arguments `--ids`, `--features` and `--models` as before.
